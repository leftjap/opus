...
| L-20 | 분석·설계 산출물에서 범위 누락·참조 불일치·전제 오류가 반복됨 | playbook.md 4-2 ALT 적용 — 범위 완전성·참조 정합성·전제 검증·누락 역추적 4항목 체크. 근거: decisions/2026-03-28-analysis-verification-checklist.md | 전체 |
...
#### 적용 조건
작업지시서 생성이 아닌 분석·설계·오류탐지·시뮬레이션 산출물을 출력할 때 수행한다.
...
#### 규칙
- 결과는 산출물 품질에만 반영한다. ALT 과정 자체를 출력하지 않는다.
- 결함 발견 시 수정 후 해당 항목만 재검증. 최대 1회 반복.
