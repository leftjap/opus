...
- 사용자가 playbook.md에 없는 백로그 ID를 언급하면 backlog-archive.md를 크롤링한다.
...
| L-14 | decisions/ 폴더 용도 범위 | 큰 결정 근거만 보관. 사소한 건 교훈 1줄. 쓰기: ①playbook/common-rules 새 섹션·규칙 체계 신설 ②아키텍처·스키마 변경 ③도구·스택 전환 검토 — 해당 시 작업지시서에 decisions/ 생성 + INDEX.md 갱신 Step 자동 포함. 읽기: ①②③과 동일 주제 논의 시 INDEX.md를 먼저 크롤링하여 기존 결정 확인 | 전체 |
