...
| keep | `C:\dev\apps\keep\` | `leftjap/keep` | 루트 | B-55 검증 대기, 로컬 일일 백업 운영 중, Sentry 에러 모니터링 도입 완료, MCP(stdio) 연동, 보안 조치 완료(Gemini+CSE 키 삭제, Code.js 데드 코드 제거, JWT 서명 검증 도입+폴백 토큰 제거, 2026-03-30) |
